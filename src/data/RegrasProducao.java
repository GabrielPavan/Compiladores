...
public class RegrasProducao {
    ...
    static {
        ...
        regras.put(5, new String[]{"var", "<LISTAVARIAVEIS>", ":", "<TIPO>", "#4", ";", "<LDVAR>"});

        regras.put(6, new String[]{"ident", "#1", "<REPIDENT>"});
        regras.put(7, new String[]{});
        regras.put(8, new String[]{",", "ident", "#1", "<REPIDENT>"});
        regras.put(9, new String[]{"<LISTAVARIAVEIS>", ":", "<TIPO>", "#4", ";", "<LDVAR>"});
        regras.put(10, new String[]{});

        regras.put(11, new String[]{"integer", "#2"});
        regras.put(12, new String[]{"real", "#3"});
        regras.put(13, new String[]{"string", "#6_STR"});
        ...
        regras.put(28, new String[]{"+", "<TERMO>", "#7", "<EXPR>"});
        regras.put(29, new String[]{"-", "<TERMO>", "#7", "<EXPR>"});
        regras.put(30, new String[]{});
        regras.put(31, new String[]{"<FATOR>", "<TER>"});
        regras.put(32, new String[]{"*", "<FATOR>", "#7", "<TER>"});
        regras.put(33, new String[]{"/", "<FATOR>", "#7", "<TER>"});
        regras.put(34, new String[]{});
        regras.put(35, new String[]{"(", "<EXPRESSAO>", ")"});
        regras.put(36, new String[]{"ident", "#5"});
        regras.put(37, new String[]{"nint", "#6_INT"});
        regras.put(38, new String[]{"nreal", "#6_REAL"});
        regras.put(39, new String[]{"literal", "#6_STR"});
        regras.put(40, new String[]{"vstring", "#6_STR"});
        ...
        regras.put(51, new String[]{"ident", "#5", "<RESTO_COMANDO_IDENT>"});
        regras.put(52, new String[]{"for", "ident", ":=", "<EXPRESSAO>", "to", "<EXPRESSAO>", "do", "<BLOCO>"});
        regras.put(53, new String[]{"<LISTAPARAMETROS>"});
        regras.put(54, new String[]{":=", "<EXPRESSAO>", "#8"});
        regras.put(55, new String[]{"(", "<PAR>", "<REPPAR>", ")"});
        regras.put(56, new String[]{});
        regras.put(57, new String[]{"ident", "#5"});
        regras.put(58, new String[]{"nint", "#6_INT"});
        regras.put(59, new String[]{"nreal", "#6_REAL"});
        regras.put(60, new String[]{"vstring", "#6_STR"});
        ...
        regras.put(65, new String[]{"literal", "#6_STR"});
