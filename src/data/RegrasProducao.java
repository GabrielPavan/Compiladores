...
public class RegrasProducao {
    ...
    static {
        ...
        regras.put(5, new String[]{"var", "<LISTAVARIAVEIS>", ":", "<TIPO>", "#3", ";", "<LDVAR>"});
        regras.put(6, new String[]{"ident", "#1", "<REPIDENT>"});
        regras.put(7, new String[]{});
        regras.put(8, new String[]{",", "ident", "#1", "<REPIDENT>"});
        regras.put(9, new String[]{"<LISTAVARIAVEIS>", ":", "<TIPO>", "#3", ";", "<LDVAR>"});
        regras.put(10, new String[]{});
        regras.put(11, new String[]{"integer", "#2_INT"});
        regras.put(12, new String[]{"real", "#2_REAL"});
        regras.put(13, new String[]{"string", "#2_STR"});
        // CORREÇÃO: Ação #10 (declarar proc) vem ANTES da #8 (abrir escopo)
        regras.put(14, new String[]{"procedure", "ident", "#10", "#8", "<PARAMETROS>", ";", "<BLOCO>", "#9", ";", "<PROCEDIMENTOS>"});
        regras.put(15, new String[]{});
        regras.put(16, new String[]{"(", "<LISTAVARIAVEIS>", ":", "<TIPO>", "#3", "<REPPARAMETROS>", ")"});
        regras.put(17, new String[]{});
        regras.put(18, new String[]{",", "<LISTAVARIAVEIS>", ":", "<TIPO>", "#3", "<REPPARAMETROS>"});
        ...
        regras.put(28, new String[]{"+", "<TERMO>", "#6", "<EXPR>"});
        regras.put(29, new String[]{"-", "<TERMO>", "#6", "<EXPR>"});
        regras.put(30, new String[]{});
        regras.put(31, new String[]{"<FATOR>", "<TER>"});
        regras.put(32, new String[]{"*", "<FATOR>", "#6", "<TER>"});
        regras.put(33, new String[]{"/", "<FATOR>", "#6", "<TER>"});
        regras.put(34, new String[]{});
        regras.put(35, new String[]{"(", "<EXPRESSAO>", ")"});
        regras.put(36, new String[]{"ident", "#4"});
        regras.put(37, new String[]{"nint", "#5_INT"});
        regras.put(38, new String[]{"nreal", "#5_REAL"});
        regras.put(39, new String[]{"literal", "#5_STR"});
        regras.put(40, new String[]{"vstring", "#5_STR"});
        ...
        regras.put(51, new String[]{"ident", "#4", "<RESTO_COMANDO_IDENT>"});
        regras.put(52, new String[]{"for", "ident", ":=", "<EXPRESSAO>", "to", "<EXPRESSAO>", "do", "<BLOCO>"});
        regras.put(53, new String[]{"<LISTAPARAMETROS>"});
        regras.put(54, new String[]{":=", "<EXPRESSAO>", "#7"});
        regras.put(55, new String[]{"(", "<PAR>", "<REPPAR>", ")"});
        regras.put(56, new String[]{});
        regras.put(57, new String[]{"ident", "#4"});
        regras.put(58, new String[]{"nint", "#5_INT"});
        regras.put(59, new String[]{"nreal", "#5_REAL"});
        regras.put(60, new String[]{"vstring", "#5_STR"});
        ...
        regras.put(65, new String[]{"literal", "#5_STR"});
